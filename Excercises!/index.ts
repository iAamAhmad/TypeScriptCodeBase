...
const messageDeclare: string = `My Favorite number is ${favoriteNumber}`;
...
//Solution 13
let guestsLists: string[] = ["Abdul", "AbuZar", "Hassan"];

function invitationMessage(one: string): string {
